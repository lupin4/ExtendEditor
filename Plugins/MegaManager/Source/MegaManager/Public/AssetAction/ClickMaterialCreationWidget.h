...
#include "ClickMaterialCreationWidget.generated.h"
 ...
 */
UCLASS()
class MEGAMANAGER_API UClickMaterialCreationWidget : public UEditorUtilityWidget
{
	GENERATED_BODY()
public:

#pragma region QuickMaterialCreator
...
#pragma endregion QuickMaterialCreator
